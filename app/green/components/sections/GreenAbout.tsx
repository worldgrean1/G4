        ...
        <div className="flex flex-col lg:flex-row h-full relative z-10">
          ...
          <div className="w-full lg:w-[55%] p-6 sm:p-8 lg:p-10 flex flex-col justify-between">
            <div className="space-y-6 sm:space-y-8">
              {/* Header */}
              <AnimatedCard delay={0.1} className="flex flex-col sm:flex-row sm:items-center sm:justify-between mb-6 sm:mb-8 gap-4">
                <div className="flex items-center space-x-3 sm:space-x-4">
                  <div className="w-12 h-12 sm:w-14 sm:h-14 rounded-full bg-[#3DD56D] flex items-center justify-center shadow-lg">
                    <Shield className="w-6 h-6 sm:w-7 sm:h-7 text-white" />
                  </div>
                  <div>
                    <h3 className="text-xl sm:text-2xl font-extrabold text-white tracking-tight">About Grean World</h3>
                    <p className="text-sm sm:text-base text-slate-300 font-medium">Sustainable Energy Initiative</p>
                  </div>
                </div>
                <div className="bg-slate-800/80 rounded-lg px-3 py-2 sm:px-4 sm:py-2 flex items-center space-x-2 border border-slate-700/60 shadow self-start sm:self-auto">
                  <div className="w-4 h-4 sm:w-5 sm:h-5 text-[#3DD56D]">
                    <Shield className="w-4 h-4 sm:w-5 sm:h-5" />
                  </div>
                  <p className="text-xs sm:text-sm font-semibold text-white">@greanworld</p>
                </div>
              </AnimatedCard>

              {/* Mission Card */}
              <AnimatedCard delay={0.2} className="bg-gradient-to-r from-[#3DD56D] to-[#2bb757] text-white p-4 sm:p-6 rounded-xl shadow-lg border border-white/10">
                ...
                <h4 className="text-lg sm:text-xl font-bold mb-2 tracking-tight">Empowering Ethiopia's Energy Transition</h4>
                <p className="text-sm sm:text-base font-medium">Founded in 2016, Grean World leads the way in providing clean, accessible, and sustainable energy to rural and peri-urban communities through innovation and community-driven solutions.</p>
              </AnimatedCard>

              {/* Features & Impact */}
              <div className="grid grid-cols-1 lg:grid-cols-2 gap-4">
                <AnimatedCard delay={0.3} className="bg-slate-800/60 p-4 sm:p-5 rounded-lg border border-slate-700/70 shadow">
                  <div className="flex items-center space-x-3 mb-2">
                    <Users className="w-5 h-5 sm:w-6 sm:h-6 text-[#3DD56D]" />
                    <h5 className="font-semibold text-white text-sm sm:text-base">Key Features</h5>
                  </div>
                  <ul className="text-xs sm:text-sm text-slate-300 space-y-1 list-disc list-inside font-medium">
                ...
                <AnimatedCard delay={0.4} className="bg-slate-800/60 p-4 sm:p-5 rounded-lg border border-slate-700/70 shadow">
                  <div className="flex items-center space-x-3 mb-2">
                    <Target className="w-5 h-5 sm:w-6 sm:h-6 text-[#3DD56D]" />
                    <h5 className="font-semibold text-white text-sm sm:text-base">Impact</h5>
                  </div>
                  <div className="grid grid-cols-2 gap-2">
                    <div className="text-center">
                      <div className="text-xl sm:text-2xl font-extrabold text-[#3DD56D]">100K+</div>
                      <div className="text-xs text-slate-400 font-medium">People Impacted</div>
                    </div>
                    <div className="text-center">
                      <div className="text-xl sm:text-2xl font-extrabold text-[#3DD56D]">10+</div>
                      <div className="text-xs text-slate-400 font-medium">Countries Reached</div>
                    </div>
                    <div className="text-center">
                      <div className="text-xl sm:text-2xl font-extrabold text-[#3DD56D]">7</div>
                      <div className="text-xs text-slate-400 font-medium">Years of Impact</div>
                    </div>
                    <div className="text-center">
                      <div className="text-xl sm:text-2xl font-extrabold text-[#3DD56D]">98%</div>
          ...
          <div className="w-full lg:w-[45%] relative overflow-hidden flex items-center justify-center min-h-[250px] lg:min-h-0">
