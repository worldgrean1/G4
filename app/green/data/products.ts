export interface Product {
  name: string;
  category: 'cooking-lower' | 'cooking-higher' | 'solar-pv' | 'pue' | 'water-pumping' | 'street-lights' | 'power-backup' | 'advisory';
  subcategory?: string;
  price: number;
  rating: number;
  tags: string[];
...
export const products: Product[] = [
  ...
  {
    name: 'Improved Wood Cookstove',
    category: 'cooking-lower',
    subcategory: 'Wood Stoves',
    price: 1200,
    rating: 4.3,
    tags: ['Eco-friendly', 'Wood Burning', 'Efficient'],
    description: 'Improved cookstove that burns wood more efficiently than traditional open fires, reducing smoke and fuel consumption.',
    sale: false,
    oldPrice: null,
    badge: null,
    targetUsers: ['Rural households', 'Small families'],
    applications: ['Daily cooking', 'Boiling water', 'Food preparation'],
    specifications: {
      efficiency: '40% more efficient than open fires',
      warranty: '2 years',
    }
  },
  {
    name: 'Charcoal Efficient Stove',
    category: 'cooking-lower',
    subcategory: 'Charcoal Stoves',
    price: 850,
    rating: 4.1,
    tags: ['Charcoal', 'Smoke Reduction', 'Durable'],
    description: 'Advanced charcoal stove designed to burn cleaner and use less fuel while providing consistent heat.',
    sale: true,
    oldPrice: 1100,
    badge: 'SALE',
    targetUsers: ['Urban households', 'Small businesses'],
    applications: ['Cooking', 'Food vendors', 'Small restaurants'],
    specifications: {
  ...
  // 2. Cooking Solutions - Higher Tier
  {
    ...
    applications: ['All cooking needs', 'Professional cooking', 'Clean cooking'],
    specifications: {
      power: '2000W',
  ...
  },
  {
    ...
    description: 'Solar PV system designed for schools and educational institutions with classroom lighting and computer power.',
    sale: false,
    oldPrice: null,
    badge: 'INSTITUTIONAL',
    targetUsers: ['Schools', 'Educational institutions'],
    applications: ['Classroom lighting', 'Computer labs', 'Administrative offices'],
    specifications: {
  ...
  },
  {
    ...
    description: 'Solar-powered milk cooling system to maintain milk quality and extend shelf life for dairy farmers.',
    sale: false,
    oldPrice: null,
    badge: 'DAIRY',
  ...
  },
  {
    ...
    description: 'Solar-powered grain milling system for processing cereals and generating income in rural communities.',
    sale: true,
    oldPrice: 42000,
    badge: 'SALE',
  ...
  // 5. Solar Water Pumping Systems
  {
    ...
    oldPrice: null,
    badge: 'AGRICULTURE',
    targetUsers: ['Large farms', 'Agricultural cooperatives', 'Commercial farmers'],
    applications: ['Large-scale irrigation', 'Crop watering', 'Agricultural production'],
    specifications: {
      power: '1HP (750W) pump',
  ...
  },
  {
    ...
    description: 'Solar-powered water pumping system for community drinking water supply in rural and off-grid areas.',
    sale: false,
    oldPrice: null,
    badge: 'COMMUNITY',
    targetUsers: ['Rural communities', 'Villages', 'Water committees'],
    applications: ['Community water supply', 'Drinking water', 'Water distribution'],
    specifications: {
  ...
  },
  {
    ...
    applications: ['Business continuity', 'Critical equipment', 'Extended outages'],
    specifications: {
  ...
  // 8. Advisory and Business Development Services
  {
    ...
    applications: ['System design', 'Feasibility studies', 'Technical consultation'],
    specifications: {
  ...
  },
  {
    ...
    applications: ['Business planning', 'Training', 'Market development', 'Scaling support'],
    specifications: {
