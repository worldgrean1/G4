...
export default function LandingPage() {
  ...
  useKeyboardShortcuts({
    onSpacePress: () => {
      toggleAnimations();
      console.log('Animations toggled:', !animationsPaused);
    },
    enabled: true
  });
        ...
        >
          <motion.div layout className="w-full flex flex-col items-center">
                ...
                {inverterActive && !booting && (
                  ...
                  >
                    <div className="flex flex-col items-center text-center px-4">
                      <h1
                        className="text-2xl sm:text-3xl md:text-4xl lg:text-5xl xl:text-6xl font-bold tracking-tight text-white mb-2 flex flex-col sm:flex-row items-center justify-center gap-2"
                      >
                        <TypingTextAnimation
                          text="Intelligent Energy Systems"
                          speed="medium"
                        />
                        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="lucide lucide-zap w-6 h-6 sm:w-8 sm:h-8 md:w-10 md:h-10 text-green-500"><path d="M4 14a1 1 0 0 1-.78-1.63l9.9-10.2a.5.5 0 0 1 .86.46l-1.92 6.02A1 1 0 0 0 13 10h7a1 1 0 0 1 .78 1.63l-9.9 10.2a.5.5 0 0 1-.86-.46l1.92-6.02A1 1 0 0 0 11 14z"></path></svg>
                      </h1>
                      <p
                        className="text-sm sm:text-base md:text-lg lg:text-xl text-gray-300 max-w-3xl mx-auto mb-2 leading-relaxed"
                      >
            ...
            <motion.div
              layout
              ref={cardRef}
              className="w-full max-w-4xl mx-auto p-4 sm:p-6 md:p-8 lg:p-10 flex flex-col items-center"
              style={{
                minHeight: typeof window !== 'undefined' && window.innerWidth < 768 ? 360 : 480,
